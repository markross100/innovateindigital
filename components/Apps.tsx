    ...
    <section id="apps" className="py-28 bg-bg2">
      <div className="container mx-auto px-[5vw]">
        <motion.div
          ...
          className="
            relative bg-gradient-to-br from-bg3 to-bg2
            border border-gold/[0.22] rounded-[2px] p-14
            grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-12 items-center
            overflow-hidden
          "
        >
          {/* Coming soon badge */}
          ...
          {/* Glow */}
          <div className="
            absolute right-[-80px] top-[-80px] w-[350px] h-[350px]
            rounded-full pointer-events-none
            bg-[radial-gradient(circle,rgba(232,240,0,0.04),transparent_65%)]
          " />
          ...
          <div className="relative z-10">
            ...
            >
              A Suite of Tools<br />Built for Automation Leaders.
            </h2>
            <p className="text-muted mt-4 max-w-[520px] leading-[1.78]">
              Beyond events, InnovateInDigital is developing a curated suite of
              Agentic AI applications — practical tools designed for the
              professionals in the room. Starting with Automation Manager.
            </p>
            ...
            <div className="mt-8">
              <a
                href="mailto:mark.ross@innovateindigital.com?subject=Agentic Applications — Early Interest"
                className="
          ...
          <div className="relative z-10 flex flex-col gap-4 min-w-[160px]">
            <div className="text-center p-5 border border-gold/[0.22] rounded-[2px] bg-bg/40">
              <div className="font-display font-bold text-yellow leading-none" style={{ fontSize: '2.2rem' }}>
                AI
              </div>
              <div className="text-[0.65rem] tracking-[0.12em] text-muted mt-1 uppercase">Powered</div>
            </div>
            <div className="text-center p-5 border border-gold/[0.22] rounded-[2px] bg-bg/40">
              <div className="font-display font-bold text-gold" style={{ fontSize: '1.6rem' }}>
                Agentic
              </div>
              <div className="text-[0.65rem] tracking-[0.12em] text-muted mt-1 uppercase">Native</div>
            </div>
          </div>
        </motion.div>
      </div>
